...
const LoadingScreen = () => (
  <motion.div
    ...
    animate={{ opacity: 1 }}
    exit={{ opacity: 0 }}
    className="fixed inset-0 flex items-center justify-center z-50 bg-gradient-to-br from-gray-900 via-black to-gray-800"
  >
    <div className="flex flex-col items-center">
      ...
      <motion.p
        ...
        transition={{ duration: 1.5, repeat: Infinity }}
        className="mt-4 text-indigo-400 text-xl font-bold"
      >
        Loading Messages...
      </motion.p>
    </div>
...
const EmptyState = () => (
  <motion.div
    ...
    animate={{ opacity: 1, y: 0 }}
    className="flex flex-col items-center justify-center h-full text-gray-500 space-y-4 py-20"
  >
    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800">
      <div className="h-screen w-full max-w-4xl flex flex-col bg-gray-900/50 backdrop-blur-sm border-l border-r border-gray-800 shadow-2xl">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700 px-4 py-4 flex items-center justify-between shadow-lg flex-shrink-0"
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-white font-bold text-lg">WallBooks Chat</h1>
          ...
          <AnimatePresence>
            {replyingTo && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: 10 }}
                className="mb-3 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-lg p-3 flex items-center justify-between border border-indigo-500/30"
              >
